...
--
-- Client :  127.0.0.1
-- Généré le :  Lun 08 Mai 2017 à 11:02
...
CREATE TABLE `members` (
  ...
  `Member_localisation` text NOT NULL,
  `Member_last_visit` date NOT NULL,
  `Membe_rank` int(11) NOT NULL,
  `Member_admin` int(11) NOT NULL,
  `Member_posts` text NOT NULL
) ENGINE=MyISAM DEFAULT CHARSET=latin1;
